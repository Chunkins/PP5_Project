...
void Model::Draw(ID3D11DeviceContext * t_devcon, ID3D11Buffer * t_cbPerObjectBuffer, XMMATRIX& t_camProjection, bool _bones = false, ID3D11ShaderResourceView* pSRVB= nullptr,ID3D11Buffer* pVBufferB= nullptr, unsigned int _count = 0u)
{
	if (Display)
	{
		if (pSRV)
